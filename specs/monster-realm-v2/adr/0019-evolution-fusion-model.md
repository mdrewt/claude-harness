...
**Confirmed as specced, no design change:** Bond retirement (folds into Trust); full essence reset on evolution, including against the already-shipped species-7 collision case; the provisional framing of the tier cap (still `<= 5`, still explicitly not final).
